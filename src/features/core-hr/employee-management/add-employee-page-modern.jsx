...
import {
  BriefcaseIcon, IdCard, UserPlus, CheckCircle, XCircle,
            ...
            <div className="flex-1 min-w-0 space-y-0">
              ...
              <div className={cn(currentStep !== 0 && "hidden")}>
                <SectionCard title="Personal Information" icon={IdCard} gradient="from-violet-500/80 to-purple-600/80" fieldCount={STEPS[0].fields.length} filledCount={allStepProgress[0].filled}>
                  <div className="space-y-5">
                    <SmartRadioGroup form={form} name="title" label="Title" options={["Mr.", "Mrs.", "Ms.", "Dr."]} />
                    ...
                    <SmartRadioGroup form={form} name="gender" label="Gender" options={["Male", "Female", "Other"]} />
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField control={form.control} name="dateOfBirth" render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-sm font-medium">Date of Birth *</FormLabel>
                          <FormControl><DatePicker value={field.value} onChange={field.onChange} placeholder="Select date of birth" /></FormControl>
                    ...
                    <SmartRadioGroup form={form} name="maritalStatus" label="Marital Status" options={MARITAL_STATUS_OPTIONS} />
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField control={form.control} name="joinDate" render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><DatePicker value={field.value} onChange={field.onChange} placeholder="Select join date" /></FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )} />
                      <FormField control={form.control} name="effectiveStartDate" render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><DatePicker value={field.value} onChange={field.onChange} placeholder="Select start date" /></FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )} />
                    </div>
                    <FormField control={form.control} name="effectiveEndDate" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><DatePicker value={field.value} onChange={field.onChange} placeholder="Select end date" /></FormControl>
                        <FormMessage className="text-xs" />
                      </FormItem>
                    )} />
                    ...
                    <SmartRadioGroup form={form} name="regDisability" label="Registered Disability" options={REG_DISABILITY_OPTIONS} />
                  </div>
                </SectionCard>
              </div>
              ...
              <div className={cn(currentStep !== 2 && "hidden")}>
                <SectionCard title="Assignment" icon={Building2} gradient="from-emerald-500/80 to-teal-600/80" fieldCount={STEPS[2].fields.length} filledCount={allStepProgress[2].filled}>
                  <div className="space-y-5">
                    <ComboboxField form={form} name="companyId" label="Company" items={companies} idKey="COMPANY_ID" nameKey="COMPANY_NAME" placeholder={companiesLoading ? "Loading..." : "Select company"} disabled={companiesLoading} />
                    <ComboboxField form={form} name="ouId" label="Operational Unit" items={organizations} idKey="ID" nameKey="NAME" placeholder={organizationsLoading ? "Loading..." : "Select operational unit"} disabled={organizationsLoading} />
                    <ComboboxField form={form} name="orgId" label="Organization" items={organizations} idKey="ID" nameKey="NAME" placeholder={organizationsLoading ? "Loading..." : "Select organization"} disabled={organizationsLoading}
                      onSelect={(org) => {
                    ...
                    />
                    <PositionComboboxField form={form} filteredPositions={filteredPositions} selectedOrgId={selectedOrgId} orgPositionsLoading={orgPositionsLoading} grades={grades} />
              ...
              <div className={cn(currentStep !== 4 && "hidden")}>
                <SectionCard title="Review & Submit" icon={FileText} gradient="from-rose-500/80 to-pink-600/80" fieldCount={0} filledCount={0}>
                  <ReviewStep form={form} personTypes={personTypes} companies={companies} organizations={organizations} grades={grades} mode="add" />
                </SectionCard>
              </div>
            ...
            <div className="max-w-screen-xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2.5 shrink-0">
                ...
                {currentStep < STEPS.length - 1 ? (
                  <Button type="button" onClick={handleNext} className="gap-1.5 bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 border-0 shadow-lg shadow-violet-500/25">
                    Continue<ChevronRight className="w-4 h-4" />
                  </Button>
                ) : (
                  <Button type="button" onClick={form.handleSubmit(onSubmit, handleFormError)} disabled={createEmployeeMutation.isPending} className="gap-1.5 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 border-0 shadow-lg shadow-emerald-500/25">
