                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <Accordion type="single" collapsible defaultValue="personal" className="bg-card/70 p-4 rounded-md shadow-sm">
                                ...
                                <Accordion type="single" collapsible className="bg-card/70 p-4 rounded-md shadow-md">
                             ...
                             {/* right column */}
                                <div className="space-y-6">
                                    {/* Employment Information */}
                                    <Accordion type="single" collapsible  className="bg-card/70 p-4 rounded-md shadow-sm">
