...
export default function AddCountryDialog({ open, onOpenChange, showConfirmation }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.error(error?.message || "Failed to create country. Please try again.");
    }
  };
