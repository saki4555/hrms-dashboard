// src\features\settings\work-structure\company\update-company-dialog.jsx
  ...
  useEffect(() => {
    if (company) {
      form.reset({
        ...
        companyDetail: company.COMPANY_DETAIL || "",
        binNo: company.BIN_NO || "",
        address: company.ADDRESS || "",
        effectiveStartDate: company.EFFECTIVE_START_DATE
          ? format(new Date(company.EFFECTIVE_START_DATE), "yyyy-MM-dd")
          : "",
        effectiveEndDate: company.EFFECTIVE_END_DATE
          ? format(new Date(company.EFFECTIVE_END_DATE), "yyyy-MM-dd")
          : "",
      });
    }
  }, [company, form]);

  // isDirty guard prevents overwriting existing end date on initial load
        ...
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <DialogDescription>
                Edit company details for "{company?.COMPANY_NAME}"
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
