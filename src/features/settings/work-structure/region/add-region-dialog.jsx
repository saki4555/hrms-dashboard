...
export default function AddRegionDialog({ open, onOpenChange, showConfirmation }) {
  ...
  useEffect(() => {
    if (open) {
      form.reset({ countryId: "", regionName: "" });
    }
  }, [open]);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.error(error?.message || "Failed to create region. Please try again.");
    }
  };
