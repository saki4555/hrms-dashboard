...
export default function AddDistrictDialog({ open, onOpenChange, showConfirmation }) {
  ...
  // Deduplicate by REGION_NAME (not REGION_ID) so Dhaka always shows
  ...
  useEffect(() => {
    if (open) {
      ...
      form.reset({ countryId: "", regionId: "", districtName: "" });
    }
  }, [open]);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.error(error?.message || "Failed to create district. Please try again.");
    }
  };
        ...
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <DialogDescription>Create a new district in the system</DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <Form {...form}>
          <div className="space-y-5">
            ...
            <DialogFooter className="gap-2 sm:gap-0">
              ...
              <Button onClick={form.handleSubmit(onSubmit)} disabled={createDistrictMutation.isPending}>
